  ...
  return (
    <div className=" ">
      <div className="grid grid-cols-2 md:grid-cols-4  gap-1">
        <div className="flex flex-col justify-center items-center ease-in duration-300 hover:scale-110 cursor-pointer border-2 rounded-md mb-10 ml-10 mr-10 p-5 border-white-500  ">
        ...
        <div className="flex flex-col justify-center items-center ease-in duration-300 hover:scale-110 cursor-pointer border-2 rounded-md mb-10 ml-10 mr-10 p-5 border-white-500  ">
          ...
          <div className="flex justify-center items-center">
            <WeatherIcon
              className="p-5 text-white text-2xl"
              name="owm"
              flip="horizontal"
              rotate="90"
